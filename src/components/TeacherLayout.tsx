...
const teacherLinks = [
  ...
  { title: "उपस्थिती", url: "/teacher/attendance", icon: Users },
    ...
    <>
      <div className="flex items-center gap-2.5 mb-8">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-sm truncate">शिक्षक पोर्टल</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:block text-right">
                ...
                <p className="text-[10px] text-muted-foreground">{user?.meta?.class || 'शिक्षक'}</p>
              </div>
            </div>
            <Button variant="ghost" size="icon" onClick={logout} title="बाहेर पडा">
